...
{
    public class BaseBuilding : GameObject, IDamageable
    {
        ...
        public bool CanTakeKnockBack { get => false; }
        public Rectangle Hitbox { get; set; }
        #endregion

        public BaseBuilding()
        {
            Texture = TextureManager.Textures[TextureIdentifier.Building];
            SpriteLayer = TextureManager.SpriteLayers[SpriteLayerIdentifier.Building];
        }
